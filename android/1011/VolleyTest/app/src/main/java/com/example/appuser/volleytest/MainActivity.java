...
public class MainActivity extends AppCompatActivity {
    ...
    String showUri = "http://10.0.2.2/VolleyTest.php";//手機模擬器連結本機伺服器
    //String showUri = "http://192.168.x.x/VolleyTest.php"; // 真實手機和伺服器在同區網內
    //String showUri = "http://www.xxx.com/VolleyTest.php"; // 真實手機和伺服器在網際網路內 140.116.xx.xx
